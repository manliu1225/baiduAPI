#! /usr/bin/env python3
from . tokenization_pos_token2 import Baiduapi
import argparse
import codecs
import logging
import pickle
...
def process(argws):
	...
	word_sentence_li, pos_sentence_li = get_pos(data_li, filename, output_dir)
	data = []
...
def get_pos(data_li, dumpf,dump_dir):
	baiduapi = Baiduapi()
	filedump = '{}/wordf_{}'.format(dump_dir,os.path.basename(dumpf))
